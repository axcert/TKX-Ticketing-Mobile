...
class _ManualCheckInBottomSheetState extends State<ManualCheckInBottomSheet> {
  ...
  // Create a fast page route for quick navigation during continuous ticket checking
  PageRouteBuilder _createFastPageRoute(Widget page) {
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) => page,
      transitionDuration: const Duration(milliseconds: 200),
      reverseTransitionDuration: const Duration(milliseconds: 200),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        // Fade + Scale animation for a snappy feel
        const begin = 0.0;
        const end = 1.0;
